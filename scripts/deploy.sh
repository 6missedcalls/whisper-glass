#!/bin/bash
# Build WhisperGlass (release), install to /Applications, sign, and launch.
#
...
APP_DIR="/Applications/WhisperGlass.app"
CONTENTS="$APP_DIR/Contents"
MACOS="$CONTENTS/MacOS"
SOURCE=".build/release/WhisperGlass"
...
cp -f "$SOURCE" "$MACOS/WhisperGlass"
